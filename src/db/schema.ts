...
export const RulePagesTable = pgTable(
  'RulePages',
  {
    id: serial('Id').primaryKey(),
    title: varchar('Title', { length: 255 }).notNull(),
...
export const SettingPagesTable = pgTable(
  'SettingPages',
  {
    id: serial('Id').primaryKey(),
    title: varchar('Title', { length: 255 }).notNull(),
...
export const AncestriesTable = pgTable(
  'Ancestries',
  {
    id: serial('Id').primaryKey(),
    title: varchar('Title', { length: 255 }).notNull(),
...
export const AncestriesTagsTable = pgTable(
  'AncestriesTags',
  {
    ancestryId: integer('AncestryId').references(() => AncestriesTable.id).notNull(),
    tagId: integer('TagId').references(() => TagsTable.id).notNull(),
  },
  (ancestriesTags) => {
    return {
...
export const AncestriesToTagsRelations = relations(AncestriesTagsTable, ({ one }) => ({
  tag: one(TagsTable, {
...
export const HeritagesTable = pgTable(
  'Heritages',
  {
    id: serial('Id').primaryKey(),
    title: varchar('Title', { length: 255 }).notNull(),
...
export const HeritagesTagsTable = pgTable(
  'HeritagesTags',
  {
    heritageId: integer('HeritageId').references(() => HeritagesTable.id).notNull(),
    tagId: integer('TagId').references(() => TagsTable.id).notNull(),
  },
  (heritagesTags) => {
    return {
...
export const HeritagesToTagsRelations = relations(HeritagesTagsTable, ({ one }) => ({
  tag: one(TagsTable, {
...
export const FeatsTable = pgTable(
  'Feats',
  {
    id: serial('Id').primaryKey(),
    title: varchar('Title', { length: 255 }).notNull(),
...
export const FeatsTagsTable = pgTable(
  'FeatsTags',
  {
    featId: integer('FeatId').references(() => FeatsTable.id).notNull(),
    tagId: integer('TagId').references(() => TagsTable.id).notNull(),
  },
  (featsTags) => {
    return {

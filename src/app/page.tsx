  ...
  return (
    <Page>
      ...
      <div className="w-full md:px-12 space-y-2">
        ...
        <p>
          Pchnąć w tę łódź jeża lub ośm skrzyń fig. Pójdźże, kiń tę chmurność w głąb flaszy! Dość błazeństw, żrą mój pęk luźnych fig.
          Mężny bądź, chroń pułk twój i sześć flag. Sznur śliw. Chłód gąb. Pot męk. Jaźń żyć. Fe! Pójdźmyż haftnąć z wklęsłości guberń.
          Znajdź pchły, wróżko! Film &quot;Teść&quot; gębą suń! Pójdź w loch zbić małżeńską gęś futryn!
        </p>
      </div>
